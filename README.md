...
> - _Daft Punk, Technologic_

## About Me

Hello world, I'm Ash. I live a simple life with simple routines and focus on the basics.
I love meditation, yoga, running, cooking, the sun, nature, family and friends, and programming.

I'm a mid-level engineer. I'm lucky to have logged many thousands of hours with computer science and web development in university CS courses, on the job at a startup, doing some website management freelancing, and at a web development bootcamp.

## Strengths:
- Debugging
- Clean code
- Ability to build quickly & execute on MVP
- Depth & breadth of computing, Internet, and web knowledge
- Simple teamwork philosophy grounded in truthfuless and consistency
- Ability to control for complexity
